...
public class slider extends Activity implements SensorEventListener {
    ...
    private void addItems() {
        ...
        for (int i = 0; i < c.getCount(); i++) {
            ...
            if (!dh.isFavorites(id)) {
                v.findViewById(R.id.favorit_star).setVisibility(View.GONE);
            }
            ...
            v.findViewById(R.id.order2).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    float priceValue = 0;
                    try {
                        priceValue = Float.parseFloat("" + p2);
                    } catch (Exception e) {
                    }
                    intent.putExtra("priceValue", priceValue);
    ...
    private void mkPoints() {
        ...
        for (int i = 0; i < flipper.getChildCount(); i++) {
            if (i != flipper.getDisplayedChild()) {
                getLayoutInflater().inflate(R.layout.point_white, container);
            } else {
                getLayoutInflater().inflate(R.layout.point, container);
            }
        }
